...
sentence_mapping_path = os.path.join(current_dir, "..", "data", "metadata", "how2sign_mapping.json")
sentence_dataset_dir = os.path.join(current_dir, "..", "data", "raw_poses", "how2sign-trial")
