...
def main():
    ...
    if args.version == 'v1':
        script_name = "train_diffusion.py"
        default_model_dir = "checkpoints/sign_mdm_v1"
        out_dir_gen = "generated"
    elif args.version == 'v2':
        script_name = "train_diffusion_v2.py"
        default_model_dir = "checkpoints_v2/sign_mdm_v2"
        out_dir_gen = "generated_v2"
    else:
        script_name = "train_diffusion_v3.py"
        default_model_dir = "checkpoints_v3/sign_mdm_v3"
        out_dir_gen = "generated_v3"
    ...
    final_mp4 = os.path.join("output", f"{safe_name}_{args.version}.mp4")
    ...
    ren_cmd = [
        sys.executable, "render_preview_video.py",
        "--input", final_pkl,
        "--out", final_mp4,
        "--fps", "15"
    ]
