...
if __name__ == "__main__":
    ...
    dataset_dir = os.path.join(current_dir, "..", "..", "data", "raw_poses", "how2sign_pkls_cropTrue_shapeFalse")
    mapping_path = os.path.join(current_dir, "..", "..", "data", "metadata", "how2sign_mapping.json")
