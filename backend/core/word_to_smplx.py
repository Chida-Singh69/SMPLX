...
class WordToSMPLX:
    def __init__(self, model_path="models", gender='neutral', viewport_width=640, viewport_height=480, device=None, outfit=None, skin_tone='medium'):
        ...
        try:
            with torch.no_grad():
                ...
                # Match sentence pipeline: use skinning weights for stable eye/eyebrow masks.
                lbs_weights = None
    ...
    def _render_pyrender_frame(self, mesh):
        ...
        try:
            ...
            # Use dark grey background [0.05, 0.05, 0.05] instead of pure black
            # so that black eyebrows are visible.
...
if __name__ == "__main__":
    ...
    dataset_dir = os.path.join(current_dir, "..", "..", "data", "raw_poses", "word-level-dataset-cpu")
