...
Example:
    python vae_train.py --pkl-dir data/raw_poses/datasett --pose-mode full182 --epochs 200
"""
...
from backend.core.pose_dataset import (
...
def parse_args():
    ...
    parser.add_argument("--pkl-dir", type=str, default="data/raw_poses/datasett")
    parser.add_argument("--out-dir", type=str, default="checkpoints/vae_weights/vae")
