...
def main():
    ...
    parser.add_argument("--pkl-dir", type=str, default="how2sign_pkls_cropTrue_shapeFalse")
    parser.add_argument("--out-dir", type=str, default="checkpoints/vae_h2s")
    ...
    cache_cmd = [
        sys.executable, "vae_inference.py", "cache",
        "--pkl-dir", str(pkl_dir),
        "--ckpt", str(ckpt_path),
    ...
    if not args.skip_blend_test:
        ...
        if len(pkl_files) < 2:
            ...
            blend_cmd = [
                sys.executable, "vae_inference.py", "blend",
